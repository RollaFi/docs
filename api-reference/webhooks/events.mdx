...
<Note>
  This event is the **only** channel that carries the UETR — it is not returned by the
  transaction endpoints. Subscribe to it if you display or store payment references for
  your users.
</Note>
