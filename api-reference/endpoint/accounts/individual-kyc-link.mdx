...
<Tip>
  Already verify identity in your own onboarding? [Submit KYC Reliance](/api-reference/endpoint/accounts/kyc-reliance) lets you upload the identity document and liveness capture you collected instead of sending the account holder through this hosted flow. It is enabled per partner.
</Tip>
