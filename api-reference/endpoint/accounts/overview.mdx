...
<Info>
  New to the Platform product? Start with the [Platform overview](/platform/overview) and [quickstart](/platform/quickstart) — this page is the endpoint-level reference for the onboarding flow.
</Info>
...
<Steps>
  ...
  <Step title="Register related persons">
    ...
    If you already verify these people yourself, [Submit Representative KYC Reliance](/api-reference/endpoint/accounts/related-person-kyc-reliance) lets you send the identity document and liveness capture you collected instead, one call per person.
  </Step>
  <Step title="Submit">
...
<Steps>
  ...
  <Step title="Complete identity verification">
    ...
    If you already verify identity yourself, [Submit KYC Reliance](/api-reference/endpoint/accounts/kyc-reliance) lets you send the identity document and liveness capture you collected instead, so your customers are not asked to verify twice.
  </Step>
  <Step title="Submit">
