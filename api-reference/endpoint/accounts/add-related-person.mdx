...
| `taxId` | string | No (required before submission) | The person's government identifier, in [the format their country of residence issues](#government-identifier). Nigerian residents send `nin` instead. Can also be patched later via [Update Related Person](/api-reference/endpoint/accounts/update-related-person) |
