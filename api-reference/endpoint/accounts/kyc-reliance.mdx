...
| `documentType` | string | No | One of `PASSPORT`, `INTERNATIONAL_PASSPORT`, `ID_CARD`, `DRIVER_LICENSE`, `RESIDENCE_PERMIT`. Defaults to `PASSPORT`. `INTERNATIONAL_PASSPORT` is an alias for `PASSPORT` and behaves identically — either is fine |
