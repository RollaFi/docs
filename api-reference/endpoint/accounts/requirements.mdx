...
|-------|------|-------------|
| `entityType` | string | `business` or `individual` — decides which of the two shapes below you get |
| `status` | string | Current application status (`draft`, `submitted`, `approved`, `rejected`, `changes_requested`) |
