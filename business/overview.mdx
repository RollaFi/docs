...
description: "Use the Rolla API to manage your own business's money"
---
...
<CardGroup cols={2}>
  <Card title="Hold multi-currency balances" icon="wallet" href="/api-reference/endpoint/wallet/wallets">
    NGN, USD, XAF, and stablecoin wallets, each with available, posted, and pending balances.
  </Card>
...
<Steps>
  <Step title="Create an API key">
    In the [dashboard](https://app.rolla.xyz) under **Settings → API Keys**. Allowlist your server IPs — payouts require it. See [Authentication](/concepts/authentication).
  </Step>
