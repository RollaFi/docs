...
## Show your own name on the payment

By default the beneficiary sees Rolla's payer details on a payout. With
[Named Payouts](/guides/named-payouts) enabled, you register your own payer names — your company,
or the customer you are paying for — and pick one per payout with `payerNameId`:
...
Set a default payer name instead and every payout that omits `payerNameId` uses it, with no
change to your payout code. Names are reviewed and registered before they can be used, so read
the [Named Payouts guide](/guides/named-payouts) before you build against it.
