---
title: "Named Payouts"
description: "Register your own payer names so beneficiaries see your name — or your customer's — on the payments you send"
---

By default, a payout you send arrives at the beneficiary's bank under Rolla's own payer details. **Named Payouts** let you register your own payer names and choose which one a beneficiary sees on each payment.

Two situations it solves:

- **Your own name on your own payments.** A supplier reconciling an invoice sees your company, not a payment processor they have never heard of.
- **Your customer's name on payments you send for them.** If you move money on behalf of businesses using your product, each payment can go out under the name of the customer it belongs to.
...
<Steps>
  ...
  <Step title="Rolla's standard payer details">
    What happens today, and what still happens if you have no default.
  </Step>
</Steps>
...
Named Payouts apply on the payout rails that can carry a registered payer. Where a rail cannot, the payout still goes out and is still tagged with your chosen name for your own records, but the beneficiary sees Rolla's standard payer details. Ask your account manager which of your corridors are covered before you promise the behaviour to your own customers.
