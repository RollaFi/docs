...
| **KYC reliance** | [Submit the identity document and liveness capture you already collected](/api-reference/endpoint/accounts/kyc-reliance) ([per related person](/api-reference/endpoint/accounts/related-person-kyc-reliance)) | You're a licensed entity running your own KYC — so customers aren't verified twice |
